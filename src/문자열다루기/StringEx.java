...
public class StringEx {
    public static void main(String[] args) {
        ...
        String b = "java";
        String c = "hello";
//        System.out.println(a.equals(b));  // a 문자열과 b 문자열을 비교해서 결과가 같으면 true 다르면 false
//        System.out.println(a.equals(c));
//        System.out.println(a.equalsIgnoreCase("HELLO")); // 대소문자 상관없이 같으면 true
//        System.out.println(a ==c);

        // indexOf(): 문자열에서 특정 문자/문자열이 시작되는 인덱스를 리턴(반환) 합니다. (인덱스는 0부터 시작)
        String d = "Hello J Jav Java";
        System.out.println(d.indexOf("va"));
        ...
        // replace(), replaceAll() : 문자열에서 특정 문자열을 다른 문자열로 대체하고자 할 떄 사용
        System.out.println(str.replaceAll("Java", "Python"));
        System.out.println(str1.replaceAll("Pineapple,",""));
        ...
        System.out.printf("오늘의 %s는 %d 입니다", "온도", 10);
