...
public class MathEx {
    public static void main(String[] args) {
        // random() : 0.0이상 1.0미만의 범위에서 임의의 double 형 값중 하나의 임의의 값 생성
        // 예 : 0 ~ 99 사이의 임의의 수 생성
        for(int i = 0; i < 100; i++) {
            System.out.println((int)(Math.random() * 100)); // 0 ~ 99 사이의 임의의 수 생성
        }

//        Random ran = new Random();
//        System.out.println(ran.nextInt(100)); // 0 ~ 99 사이 임의의 수 생성
        ...
        System.out.println(Math.round(10.009));
