...
//        System.out.println(pitches);
        ...
        List<String> pitches1 = new ArrayList<>(Arrays.asList(data)); // 이미 만들어져 있는 배열을 추가
       // String result = String.join(",", pitches1); // 콤마로 구분하여 문자열 만들기
        pitches1.sort(Comparator.naturalOrder()); // 오름 차순 정렬
        System.out.println(pitches1);
        pitches1.sort(Comparator.reverseOrder()); // 내림 차순 정렬
        System.out.println(pitches1);
    }
}
